 ...
 * Features: Hero, Menu by Categories, Gallery, Contact, Shopping Cart
 */

// Category images mapping
const categoryImages: Record<string, string> = {
  'Entradas': 'https://d2xsxph8kpxj0f.cloudfront.net/310519663461231402/ZAf6EHxtQifi3Kavc8aaUS/hero-viking-bbq-3S2okLQNr3KdoQqpbAvFWW.webp',
  'Adicionales': 'https://d2xsxph8kpxj0f.cloudfront.net/310519663461231402/ZAf6EHxtQifi3Kavc8aaUS/grilled-meats-showcase-mEd2HQqfuNdswKX6dqyubt.webp',
  'Especiales': 'https://d2xsxph8kpxj0f.cloudfront.net/310519663461231402/ZAf6EHxtQifi3Kavc8aaUS/hero-viking-bbq-3S2okLQNr3KdoQqpbAvFWW.webp',
  'Salchipapas y Patatas': 'https://d2xsxph8kpxj0f.cloudfront.net/310519663461231402/ZAf6EHxtQifi3Kavc8aaUS/grilled-meats-showcase-mEd2HQqfuNdswKX6dqyubt.webp',
  'Patatas Mini': 'https://d2xsxph8kpxj0f.cloudfront.net/310519663461231402/ZAf6EHxtQifi3Kavc8aaUS/hero-viking-bbq-3S2okLQNr3KdoQqpbAvFWW.webp',
  'Chuzos Desgranados': 'https://d2xsxph8kpxj0f.cloudfront.net/310519663461231402/ZAf6EHxtQifi3Kavc8aaUS/grilled-meats-showcase-mEd2HQqfuNdswKX6dqyubt.webp',
  'Hamburguesas': 'https://d2xsxph8kpxj0f.cloudfront.net/310519663461231402/ZAf6EHxtQifi3Kavc8aaUS/hero-viking-bbq-3S2okLQNr3KdoQqpbAvFWW.webp',
  'Perros': 'https://d2xsxph8kpxj0f.cloudfront.net/310519663461231402/ZAf6EHxtQifi3Kavc8aaUS/grilled-meats-showcase-mEd2HQqfuNdswKX6dqyubt.webp',
  'Sandwich Gratinado': 'https://d2xsxph8kpxj0f.cloudfront.net/310519663461231402/ZAf6EHxtQifi3Kavc8aaUS/hero-viking-bbq-3S2okLQNr3KdoQqpbAvFWW.webp',
  'Sandwich Panini': 'https://d2xsxph8kpxj0f.cloudfront.net/310519663461231402/ZAf6EHxtQifi3Kavc8aaUS/grilled-meats-showcase-mEd2HQqfuNdswKX6dqyubt.webp',
  'Carnes': 'https://d2xsxph8kpxj0f.cloudfront.net/310519663461231402/ZAf6EHxtQifi3Kavc8aaUS/grilled-meats-showcase-mEd2HQqfuNdswKX6dqyubt.webp',
};
...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      {/* Menu Section - Categories as Cards */}
      <section id="menu" className="py-16 md:py-24 bg-transparent">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="viking-title text-4xl md:text-5xl text-white mb-4 drop-shadow-lg">
              Nuestro Menú Épico
            </h2>
          ...
          <div className="space-y-6">
            {Object.entries(menuData).map(([category, items]) => (
              <CategoryCard
                key={category}
                title={category}
                image={categoryImages[category] || categoryImages['Carnes']}
                items={items as any[]}
              />
            ))}
          </div>
      ...
      {/* Gallery Section */}
      <section id="galeria" className="py-16 md:py-24 bg-white/10 backdrop-blur-sm">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="viking-title text-4xl md:text-5xl text-white mb-4 drop-shadow-lg">
              Galería en Vivo
      ...
      <section className="py-16 md:py-24 bg-white/10 backdrop-blur-sm">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="viking-title text-4xl md:text-5xl text-white mb-6 drop-shadow-lg">
                Calidad Premium
              </h2>
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-white">Ingredientes Premium</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-accent text-2xl">🔥</span>
                  <span className="font-bold text-white">Cocinado a la Perfección</span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-accent text-2xl">🍖</span>
                  <span className="font-bold text-white">Sabores Auténticos</span>
                </li>
              </ul>
            </div>
      ...
      <section className="py-16 md:py-24 bg-white/10 backdrop-blur-sm">
        <div className="container text-center">
          ...
          <a
            href="#menu"
            className="inline-block bg-primary text-primary-foreground font-bold py-4 px-8 rounded-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 viking-button border-2 border-accent"
          >
            Ver Menú Completo
          </a>
        </div>
