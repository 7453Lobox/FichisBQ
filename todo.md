...
## Reorganización del Menú (Sesión 5)

- [x] Actualizar estructura del menú JSON con categorías como objetos principales
- [x] Crear componente de tarjeta de categoría expandible
- [x] Agregar textura de fondo Viking a toda la página
- [x] Actualizar página Home con nuevo layout
- [x] Eliminar botón "Todos" del filtro de categorías
- [x] Probar responsividad en móvil y desktop
